              ...
              <Card>
                ...
                <div className="space-y-4 text-gray-600">
                  <div className="flex items-center">
                    ...
                    <a href="mailto:swanubhavjourneys@gmail.com" className="hover:text-primary transition-smooth">
                  ...
                  <div className="flex items-center">
                    ...
                    <a href="tel:+919850078455" className="hover:text-primary transition-smooth">
                      9850078455
                    </a>
                  </div>
                </div>
